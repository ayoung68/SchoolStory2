...
# According to the histogram of the residuals, there is no evidence of the data violating 
# the normality assumption, due to few influential observations.

# Compute the K-S normality test
ks.test(R.hills, "pnorm")

# The p-value for the normality test is 0.03657. With a P-value only slightly less than 
# the 0.05 value used for significance, we do not reject the null and assume the data show
